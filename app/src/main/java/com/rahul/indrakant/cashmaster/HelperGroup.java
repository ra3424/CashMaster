...
public class HelperGroup extends SQLiteOpenHelper {
    private SQLiteDatabase sqLiteDatabase;

    private String tbname;
    public HelperGroup(Context context,String name)
    {
    ...
    public  String save(BeanGroup beanGroup)
    {
        String msg;
        ...
        try {
            ...
            contentValues.put("name",beanGroup.getName());
            contentValues.put("category",beanGroup.getCategory());
            contentValues.put("price",beanGroup.getPrice());
            contentValues.put("date",beanGroup.getDate());
